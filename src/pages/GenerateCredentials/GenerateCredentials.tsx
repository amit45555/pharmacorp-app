...
const GenerateCredentials: React.FC = () => {
  ...
  const userId = data.userId || "JOHN@81";
    ...
    <div className={styles.container}>
      ...
      <div className={styles.approvalCard}>
        ...
        <p className={styles.approvalSubtitle}>
          Your access request has been approved. Generate your login credentials
          below.
        </p>
        <div className={styles.infoGrid}>
          ...
          <div>
            <span className={styles.infoLabel}>Valid Until:</span> {validUntil}
          </div>
        </div>
      </div>
      ...
      <div className={styles.credCard}>
        ...
        <div className={styles.credFieldRow}>
          ...
          <div className={styles.credInputWrap}>
            <input className={styles.credInput} value={userId} readOnly />
            <button
        ...
        <div className={styles.credFieldRow}>
          ...
          <div className={styles.passwordStrengthRow}>
            ...
            <span className={styles.passwordStrengthText}>Strong Password</span>
          </div>
        </div>
